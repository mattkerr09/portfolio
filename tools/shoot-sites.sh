...
echo
echo "  2. NO LONGER TRUE, checked 2026-09-02: builtbykerr.com does NOT serve"
echo "     these. Its index.html references apple-touch-icon, headshot,"
echo "     icon-512 and og-card, and nothing else. docket-site.webp and"
echo "     adplaybook-site.webp sit in its assets directory referenced by"
echo "     nothing — mirrored there by sessions following this very step"
echo "     after the page stopped using them. Do not copy them. The two"
echo "     dead files are left in place rather than deleted: they are"
echo "     published URLs, so removing them is Matthew's call."
echo
